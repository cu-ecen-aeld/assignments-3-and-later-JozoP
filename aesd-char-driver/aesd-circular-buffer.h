...
extern size_t aesd_get_total_size(struct aesd_circular_buffer *buffer);

extern long aesd_get_offset(struct aesd_circular_buffer *buffer, uint32_t write_cmd, uint32_t write_cmd_offset);
